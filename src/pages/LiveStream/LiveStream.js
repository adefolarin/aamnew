      ...
      <div>
        <Container style={{ position: 'relative' }}>
          ...
          <Row>
            ...
            <Col sm={4}>
              <h4 id="bluecolor" class='text-center'>LATEST MESSAGES</h4>
            </Col>
            <Col sm={4}><hr style={{ borderTop: '1px solid red' }}></hr></Col>
            <br></br><br></br><br></br>
          </Row>
                              ...
                              <div className='livebtn'>
                                <p>
                                  <ButtonGroup className="me-2" aria-label="First group">
                                    ...
                                    <Link to="#" className='btn btn-danger' id="livevidbtn" onClick={() => {loadVideo(sermonData.snippet.title,sermonData.id.videoId,values)}}>
